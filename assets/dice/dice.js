...
const DICE = (function() {
    ...
    var vars = { //todo: make these configurable on init
        ...
        dice_color: '#4B2F8C',
        ambient_light_color: 0xcbb8ff,
        spot_light_color: 0xf3e8ff,
        use_shadows: true,
    ...
    that.dice_box.prototype.reinit = function(container) {
        ...
        vars.scale = Math.sqrt(this.w * this.w + this.h * this.h) / 3;
        ...
        if (this.barriers) {
            this.barriers[0].position.set(0, this.h * 0.93, 0);
            this.barriers[1].position.set(0, -this.h * 0.93, 0);
            this.barriers[2].position.set(this.w * 0.93, 0, 0);
            this.barriers[3].position.set(-this.w * 0.93, 0, 0);
        }
    ...
    that.dice_box.prototype.pause = function() {
        this.paused = true;
    }
    ...
    function playSound(outerContainer, soundVolume) {
        // sound asset not bundled in this prototype; no-op
        return;
    }
